...
<ul id="column2" class="column">
  <li class="widget color-red">  
    ...
    if (empty($_SESSION['last_key']) || empty($_SESSION['last_key']['oauth_token']) || empty($_SESSION['last_key']['oauth_token_secret'])) {
        $weibologin = true;
   ...
   $callback = 'http://friendstream.ca/include/weibo/callback2.php';
   ...
   $_SESSION['keys'] = $keys;
    ...
    switch ($o->http_code) {
	 ...
	 if (!isset($_SESSION['weibo']))
	    {
        $weibo = new WeiboClient( WB_AKEY , WB_SKEY , $_SESSION['last_key']['oauth_token'] , $_SESSION['last_key']['oauth_token_secret']  );
	...
	if ($weibologin)
	   ...
	   echo '<div class="snaoauth"><p><img src="../images/weibo48x48.png" alt="Sign out of Weibo" width="20px" height="20px"/><a class="button red" href="../include/twitterapi/clearsession.php?weibo=clear">退出新浪微博</a> | ';
	   ...
	   echo ' | <img src="../images/adept_update.png" alt="refresh" width="25px" height="25px"/><a id="weiborefresh" href="javascript:void(0);" onclick="getAjaxUpdates(\'get_weibos_pin\', \'\', \'weibolist\')" title="refresh weibos">刷新微博</a></p></div>';
...
<div class="columnleft">
  ...
  <div style="overflow:auto; overflow-x: auto; height:380px; width:100%; -moz-border-radius: 15px;">
    <ul class="updates">
      ...
      <li>Change to use www.goo.gl shorten url service instead of Sina's<span> Mar 14, 2011 </span></li>
...
<br />
<div id="watermark_box"><a class="watermarklink" href="javascript:void(0);"><img src="../images/preview-10.png" height=0 width=0 class="watermark" onclick="zC('../images/fspre3cut.png')"/><img src="../images/fspre3cut.png" onclick="zC('../images/fspre3cut.png', 1024, 800)" class="preview" /></a></div>
</div>
...
<ul id="column-footer" class="column">
  <li class="widget color-black" id="intro">
   ...
   <h3>Site Partners</h3>
	...
	<li><a target="_blank" href="http://www.110mb.com/aff.php?un=tianye"><strong>110mb hosting</strong></a> - Reliable Free Webhosting</li>
...
<div class="columnleft" style="width:25%;">      
   <h4>&copy; copyright 2010 - 2012 <a href="http://friendstream.ca">Friendstream.ca</a></h4>
	<ul>

     <li>
     <span class="notice"><p>Developed by: <a target="_blank" href="http://twitter.com/yehenrytian"><strong>Ye Henry Tian</strong></a></p></span>
     </li>
     ...
     <!-- AddThis Button END -->
      ...
      <li>
      <a href="./">
      <strong>RSS Feed <img src="../images/rssfeed.gif" alt="RSS" style="width:15px; height:15px; border:0; padding:0px; background-color:#FFF"/></strong></a>
      </li>
    </ul>
</div>
